...
@interface ModeSettingsVC : StaticDataTableViewController
...
@property (weak, nonatomic) IBOutlet UIButton *resetAllSettingsForMode1;
@property (weak, nonatomic) IBOutlet UILabel *resetSettingsMode1Label;
