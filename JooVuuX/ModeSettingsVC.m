    ...
    if ([self.appDelegate isConnected]) {
        if ([[[CameraManager cameraManager] allSettingsDict] isKindOfClass:[NSMutableDictionary class]]) {
            ...
            dict = @[
                     ...
                     @{@"rotate_video":rotateDegreesCheck?@"on":@"off"},
...
-(void) loadAllSettings
{
    ...
    array = [[[CameraManager cameraManager] allSettingsDict] valueForKey:@"modeOne"];
    ...
    if (![[settings valueForKey:@"rotate_video"] isEqualToString:@"on"]) {
...
//            [[CameraManager cameraManager] resetAllSettings];
        ...
        [[CameraManager cameraManager] resetAllSettings:@"on" type:@"rotate_video"];
